    ...
    while not adivinado:
        ...
        if adivinanza.isdigit():
            ...
            if adivinanza < numero_secreto:
                ...
                print(
                    f"Felicitaciones has ganado! El número {adivinanza} es el secreto y los has logrado en {intentos} intentos."
                )
        else:
            print("Por favor ingrese un número valido del 1 al 100")
